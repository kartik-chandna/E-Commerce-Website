...
//Getting the products price and number of items
global $db;
$total = 0;
$status = 'Pending';
$invoice_no = mt_rand();
...
$run_order = mysqli_query($con , $insert_order);
	...
	$messsage = "
		...
		<html>
			<p>
			Hello dear <b style='color:blue;'>$customer_name</b>, you have ordered some products on our website mysite.com, please find your order details below and pay the dues as soon as possible, so we can proceed your order, Thank you!</p>
			...
			<h3>Thank you for your order on -www.Mysite.com</h3>
		</html>

	";

	mail($customer_email , $subject, $messsage, $from);
